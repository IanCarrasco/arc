...
export default function ChatPanel({ paperUrl }: ChatPanelProps) {
  ...
  return (
    <div className="flex flex-col h-full max-h-full">
      ...
      {/* Chat Messages Area */}
      <div className="flex-1 px-4 py-4 space-y-4 overflow-y-auto min-h-0 max-h-full">
        {/* Welcome Message */}
      ...
      {/* Input Area */}
      <div className="border-t border-gray-200 dark:border-gray-800 p-6 flex-shrink-0">
